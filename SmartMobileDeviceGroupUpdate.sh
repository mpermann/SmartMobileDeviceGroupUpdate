...
# Name: SmartMobileDeviceGroupUpdate.sh
# Date: 04-23-2022
...
# Purpose: Updates smart mobile device group using group name and list of full names.
# Group name and path to list of full names can be provided as command line arguments or they 
# can be provided interactively. If the group doesn't exist, it will be created. Please avoid 
# spaces in file name or paths.
# Usage: SmartMobileDeviceGroupUpdate.sh "Smart_Mobile_Device_Group_Name" "/path/to/list/of/full/names"
...
then
    ...
    /bin/echo "Provide path to file containing full names"
...
do
    ...
    groupXML="$groupXML<criterion><name>Full Name</name><priority>$i</priority><and_or>or</and_or><search_type>is</search_type><value>${inputArray[$i]}</value></criterion>"
